    ...
    <div>
      <div className={styles.aboutContainer}>
        ...
        <p>
          ...
          and motivation? Well, we've got something extraordinary for you!
          Introducing HustleX, the gamified fitness app that transforms your
          workout experience into a thrilling game. With HustleX, we've
          integrated captivating game mechanics like XP, Levels, Streaks, and
          Leaderboards into your everyday fitness routine. No more boring
          workouts or lackluster progress tracking – we make fitness fun and
          engaging, just like playing a game! <br /> <br />
          Here's how it works: as you embark on your fitness journey, achieving
          ...
          But it doesn't stop there. With your hard-earned Hustle Coins, you
          ...
          That's why we strive to create an app that caters to your individual
          ...
          focus on what truly matters – achieving your fitness goals. <br />{" "}
          <br />
          ...
          If you haven't joined the HustleX community yet, we invite you to
          ...
          <br /> <br />
          Remember, at HustleX, fitness is no longer a chore – it's a thrilling
